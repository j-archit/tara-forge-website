...
import { HeroConstellation } from "@/components/CelestialBackground";

export default function HomePage() {
  return (
    <main className="design-page relative flex min-h-screen flex-col selection:bg-brand-gold/20">
      <Navbar />

      {/* Hero Section - Optimized for LCP */}
      <section className="design-section design-hero relative flex min-h-[calc(100dvh-80px)] flex-col justify-center overflow-hidden">
        <HeroConstellation />
        <div className="section-max-width design-container relative">
          <HeroClient>
            <div className="flex items-center gap-3 mb-6 group justify-center sm:justify-start">
              ...
              <span className="design-rule sm:hidden" />
            </div>
            ...
            <h1 className="mt-5 text-balance text-4xl font-semibold tracking-tight text-slate-50 sm:text-5xl lg:text-6xl text-center sm:text-left">
              Your best ideas.{" "}
              <span className="hero-gradient-text block">Tangible and tough.</span>
            </h1>
            ...
            <p className="mt-6 max-w-xl text-pretty text-base leading-relaxed text-slate-300 lg:text-lg">
              ...
              <span className="design-accent block mt-4">
            ...
            <div className="mt-6 flex flex-col gap-3 text-sm sm:flex-row sm:items-center">
              <Link
                ...
                className="design-button design-primary design-hero-cta"
              >
                Get a quote
                <span className="design-button-note">— email your design</span>
              </Link>
              <Link
                href="/gallery"
            ...
            <div className="mt-10 flex flex-wrap gap-4 justify-center sm:justify-start">
              {[
                ...
                <div key={idx} className="design-badge flex flex-col items-center sm:items-start gap-1">
                  <div className="flex items-center gap-2">
                    <span className="spark" aria-hidden="true" />
                    <span className="design-label">{badge.label}</span>
                  </div>
      ...
      <ServiceCards />
      <CoreValues />
      <section id="about" className="design-section relative border-b border-line">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                {[
                  ...
                  <div key={idx} className="flex gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center">
                      <span className="design-spark-glyph" aria-hidden="true">✶</span>
                    </div>
                    <div>
            ...
            <div className="flex flex-col items-center group">
              ...
              <div className="mt-2 flex flex-col items-center gap-2 text-center">
                <div className="design-badge flex items-center gap-3">
                  <span className="spark" aria-hidden="true" />
